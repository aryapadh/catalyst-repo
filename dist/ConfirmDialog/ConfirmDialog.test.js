...
test("basic snapshot - with opening the dialog", function () {
  ...
  var _render = (0, _tests.render)(_react.default.createElement(_ConfirmDialog.default, {
    title: "Are you sure?",
...
test("basic snapshot - with opening the dialog using the useConfirmDialog hook", function () {
  ...
  function TestComponent() {
    ...
    return _react.default.createElement(_react.default.Fragment, null, _react.default.createElement(_Button.default, {
      ...
      onClick: openDialog,
      variant: "contained"
    }, "Open Confirm Dialog"), _react.default.createElement(ConfirmDialogComponent, null));
  }

  var _render2 = (0, _tests.render)(_react.default.createElement(TestComponent, null)),
...
test("basic snapshot - with opening the dialog using the useConfirmDialog hook with more content", function () {
  ...
  function TestComponent() {
    var _useConfirmDialog2 = (0, _useConfirmDialog3.default)({
      title: "Are you sure?",
      content: _react.default.createElement("span", null, "More content"),
      message: "Are you sure you want to do that?"
    }),
  ...
  var _render3 = (0, _tests.render)(_react.default.createElement(TestComponent, null)),
