...
export default function useConfirmDialog(_ref) {
  var content = _ref.content,
      ...
      props = _objectWithoutProperties(_ref, ["content", "children", "closeOnConfirm", "onClose", "onConfirm"]);
  ...
  return {
    ...
    ConfirmDialog: function ConfirmDialog() {
      return React.createElement(ConfirmDialogBase, _extends({
        isOpen: isOpen,
        onClose: closeDialog,
