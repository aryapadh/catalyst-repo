...
var ConfirmDialogBase = _react.default.forwardRef(function ConfirmDialogBase(props, ref) {
  ...
  return _react.default.createElement(_Dialog.default, (0, _extends2.default)({
    ...
    open: isOpen,
    ref: ref
  }, otherProps), _react.default.createElement(_DialogTitle.default, {
    id: "confirm-action-dialog-title"
  }, title), message && _react.default.createElement(_DialogContent.default, null, _react.default.createElement(_DialogContentText.default, null, message)), children && _react.default.createElement(_DialogContent.default, null, children), _react.default.createElement(_DialogActions.default, null, _react.default.createElement(_Button.default, {
    onClick: onClose,
    color: "primary",
    variant: "outlined"
  }, cancelActionText), _react.default.createElement(_Button.default, {
    onClick: onConfirm,
    color: "primary",
    variant: "contained"
  }, confirmActionText)));
