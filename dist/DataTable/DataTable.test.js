...
function TestTable() {
  ...
  return _react.default.createElement(_.default, dataTableProps);
} // Basic table
...
function TestTableWithServerSidePagination() {
  ...
  var onFetchData = (0, _react.useCallback)(
  /*#__PURE__*/
  function () {
...
test("basic snapshot - only default props", function () {
  var _render = (0, _index.render)(_react.default.createElement(TestTable, null)),
  ...
  return _regenerator.default.wrap(function _callee2$(_context2) {
    while (1) {
      switch (_context2.prev = _context2.next) {
        case 0:
          _render2 = (0, _index.render)(_react.default.createElement(TestTableWithServerSidePagination, null)), asFragment = _render2.asFragment, getByText = _render2.getByText;
          _context2.next = 3;
  ...
  return _regenerator.default.wrap(function _callee3$(_context3) {
    while (1) {
      switch (_context3.prev = _context3.next) {
        case 0:
          _render3 = (0, _index.render)(_react.default.createElement(TestTableWithServerSidePagination, null)), asFragment = _render3.asFragment, getByText = _render3.getByText;
          _context3.next = 3;
          return (0, _index.waitForElement)(function () {
            return getByText("10000001");
          });
  ...
  return _regenerator.default.wrap(function _callee4$(_context4) {
    while (1) {
      switch (_context4.prev = _context4.next) {
        case 0:
          _render4 = (0, _index.render)(_react.default.createElement(TestTableWithClientSidePagination, null)), asFragment = _render4.asFragment, getByText = _render4.getByText;
          _context4.next = 3;
          return (0, _index.waitForElement)(function () {
            return getByText("10000001");
          });
  ...
  return _regenerator.default.wrap(function _callee5$(_context5) {
    while (1) {
      switch (_context5.prev = _context5.next) {
        case 0:
          _render5 = (0, _index.render)(_react.default.createElement(TestTableWithClientSidePagination, null)), asFragment = _render5.asFragment, getByText = _render5.getByText;
          _context5.next = 3;
          return (0, _index.waitForElement)(function () {
            return getByText("10000001");
          });
