...
var DataTable = _react.default.forwardRef(function DataTable(props, ref) {
  ...
  if (isLoading) {
    ...
    for (var index = 0; index < pageSize; index += 1) {
      loadingRows.push(_react.default.createElement(_core.TableRow, {
        ...
        }, column.id === "selection" ? _react.default.createElement(_core.Box, {
          paddingLeft: "12px",
          paddingTop: "13px",
          paddingBottom: "12px"
  ...
  if (page.length < pageSize && !isLoading) {
    ...
    for (var _index = page.length; _index < pageSize; _index += 1) {
      extraRows.push(_react.default.createElement(_core.TableRow, {
  ...
  return _react.default.createElement(_react.default.Fragment, null, ToolbarComponent(props) || shouldShowStandardToolbar && _react.default.createElement(_core.Toolbar, null, actionMenuProps && _react.default.createElement(_core.Box, {
    paddingRight: 2
  }, _react.default.createElement(_ActionMenu.default, (0, _extends2.default)({
    children: "Actions"
  }, actionMenuProps))), isFilterable && _react.default.createElement(_react.default.Fragment, null, _react.default.createElement(_core.TextField, {
    ...
    paddingLeft: 2
  }, _react.default.createElement(_core.ButtonGroup, null, activeFilters.slice(0, maxFilterButtons).map(function (column, index) {
    return column.render("Filter", {
      key: index,
      labels: {
        clear: labels.clearFilter,
    ...
    position: "sticky"
  }, _react.default.createElement(_core.Toolbar, null, _react.default.createElement(_core.Box, {
    flex: 1,
    paddingLeft: 2
  }, _react.default.createElement(_core.Typography, {
    variant: "h3"
  }, labels.allFiltersDrawerTitle)), _react.default.createElement(_core.IconButton, {
    onClick: handleCloseDrawer
  }, _react.default.createElement(_Close.default, null)))), _react.default.createElement(_core.Box, {
    paddingTop: 1,
    marginLeft: "-1px",
    marginRight: "-1px"
  }, filterDrawerComponents)))))), _react.default.createElement(_DataTableFilterChipBar.default, {
    columns: flatColumns,
    filters: filters,
  ...
  }, _react.default.createElement(_core.Table, (0, _extends2.default)({
    ref: ref
  }, getTableProps()), _react.default.createElement(_core.TableHead, {
    className: classes.tableHead
  }, headerGroups.map(function (headerGroup) {
    return _react.default.createElement(_core.TableRow, headerGroup.getHeaderGroupProps(), headerGroup.headers.map(function (column) {
      if (column.show === false) return null;
      return _react.default.createElement(_core.TableCell, (0, _extends2.default)({
    ...
    return prepareRow(row) || _react.default.createElement(_core.TableRow, (0, _extends2.default)({
  ...
  }), extraRows))), PaginationComponent(props) || _react.default.createElement(_core.Toolbar, null, _react.default.createElement(_core.Box, {
    display: "flex",
    alignItems: "center",
    paddingRight: 2
  }, _react.default.createElement(_core.Typography, {
    component: "span",
    variant: "body2"
  }, labels.page), _react.default.createElement(_core.Box, {
    maxWidth: 80,
    paddingLeft: 1,
    paddingRight: 1
  ...
  }, _react.default.createElement(_ChevronLeft.default, null), " ", labels.previous), _react.default.createElement(_core.Typography, {
    component: "span"
  }, " | "), _react.default.createElement(_Button.default, {
    onClick: function onClick() {
      return nextPage();
  ...
  }, labels.next, " ", _react.default.createElement(_ChevronRight.default, null))));
});
