...
test("basic snapshot - only default props", function () {
  var _render = (0, _index.render)(_react.default.createElement(_SplitButton.default, {
    options: options
  })),
...
test("set initial selected option to destructive option snapshot", function () {
  var _render2 = (0, _index.render)(_react.default.createElement(_SplitButton.default, {
  ...
  return _regenerator.default.wrap(function _callee$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          _render3 = (0, _index.render)(_react.default.createElement(_SplitButton.default, {
            options: options
