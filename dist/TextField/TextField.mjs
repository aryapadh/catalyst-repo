...
import { refType } from "@material-ui/utils"; // Styles for the base input component

var useInputStyles = makeStyles(function (theme) {
  return {
    root: {
      "position": "relative",
...
var useInputLabelStyles = makeStyles(function (theme) {
  return {
    root: _objectSpread({
...
var useFormHelperTextStyles = makeStyles(function (theme) {
  return {
    root: _objectSpread({}, theme.typography.body2, {
