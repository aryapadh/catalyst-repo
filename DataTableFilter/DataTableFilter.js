...
var DataTableFilter = _react.default.forwardRef(function DataTableFilter(props, ref) {
  ...
  if (isMulti) {
    ...
    menuItems = _react.default.createElement(_core.RadioGroup, {
  ...
  if (container === "card") {
    ...
    }, _react.default.createElement(_core.Typography, null, title)), _react.default.createElement(_core.ExpansionPanelDetails, {
      className: classes.expansionPanelDetails
    }, _react.default.createElement(_core.Box, null, _react.default.createElement(_core.List, null, menuItems, _react.default.createElement(_core.ListItem, {
      key: "clear-button"
  ...
  return _react.default.createElement(_react.Fragment, null, _react.default.createElement(_Button.default, (0, _extends2.default)({
    ...
    ref: anchorRef,
    variant: "outlined"
  }, otherProps), title, _react.default.createElement(_core.Box, {
    display: "flex",
    paddingLeft: 1
  }, _react.default.createElement(_ChevronDown.default, null))), _react.default.createElement(_core.Menu, {
    MenuListProps: {
      disablePadding: true
    },
    ...
    primary: title
  }))), menuItems, _react.default.createElement(_core.ListItem, {
    key: "clear-button"
  }, _react.default.createElement(_core.Link, {
    component: "button",
    variant: "body2",
