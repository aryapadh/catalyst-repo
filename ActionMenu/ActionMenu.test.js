...
test("basic snapshot - only default props", function () {
  var _render = (0, _index.render)(_react.default.createElement(_ActionMenu.default, {
    options: options
  }, "Actions")),
  ...
  return _regenerator.default.wrap(function _callee$(_context) {
    while (1) {
      switch (_context.prev = _context.next) {
        case 0:
          onSelect = jest.fn();
          _render2 = (0, _index.render)(_react.default.createElement(_ActionMenu.default, {
            onSelect: onSelect,
            options: options
    ...
    while (1) {
      switch (_context2.prev = _context2.next) {
        case 0:
          ...
          _render3 = (0, _index.render)(_react.default.createElement(_ActionMenu.default, {
    ...
    while (1) {
      switch (_context3.prev = _context3.next) {
        case 0:
          ...
          _render4 = (0, _index.render)(_react.default.createElement(_ActionMenu.default, {
            options: optionsWithAnOnClick
