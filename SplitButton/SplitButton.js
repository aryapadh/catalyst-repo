...
var SplitButton = _react.default.forwardRef(function SplitButton(props, ref) {
  ...
  return _react.default.createElement(_react.Fragment, null, _react.default.createElement(_core.ButtonGroup, {
    variant: "contained",
    ref: anchorRef
    ...
    onClick: handleClick
  }, otherProps), selectedOption.label), _react.default.createElement(_Button.default, {
    color: color,
  ...
  }, _react.default.createElement(_MenuDown.default, null))), _react.default.createElement(_core.Menu, {
    open: open,
